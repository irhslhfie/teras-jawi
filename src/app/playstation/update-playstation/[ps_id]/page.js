...
const UpdatePlaystation = () => {
    ...
    const { data: dataCabang, isLoading: branchLoading, error: branchError } = useGetBranchAll();
    ...
    return (
        <AuthWrapper allowedRoles={["admin", "owner"]}>
            <Layout>
                <Box sx={{ maxWidth: '100%', minHeight: 400, mx: 'auto', mt: 5, backgroundColor: '#ffffff', py: 3, px: 4, borderRadius: '12px' }}>
