...
function EnhancedTableToolbar(props) {
  ...
  const deleteUser = useDeleteProperty();
  ...
  const handleConfirmDelete = () => {
    ...
    itemSelected.forEach((property_id) => {
      deleteUser.mutate(property_id);
    });
    setIsModalOpen(false);
  };
  ...
  return (
    <>
      ...
      <ConfirmationModal
        ...
        content="Apakah Anda yakin ingin menghapus Rumah ini?"
      />
    </>
  );
}
...
export default function TableProperty({
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelected = data.map((n) => n.property_id);
              ...
              >
                ...
                <TableBody>
                  {visibleRows.map((row, index) => {
                    const isItemSelected = selected.includes(row.property_id);
                    ...
                    return (
                      ...
                      >
                        <TableCell padding="checkbox">
                          <Checkbox
                            onClick={(event) =>
                              handleClick(event, row.property_id)
                            }
                            color="primary"
                        ...
                        <TableCell align="left">
                          <Button
                            ...
                            onClick={() =>
                              router.push(
                                `/property/update-property/${row.property_id}`
                              )
                            }
                          >
                            Edit
