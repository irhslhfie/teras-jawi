      ...
      >
        ...
        >
          ...
          <Box sx={{ display: "flex", alignItems: "center" }}>
            ...
            >
              <span style={{ color: "#1565c0" }}>Teras</span>
              <span style={{ color: "black" }}>Jawi</span>
            </Typography>
          </Box>
          ...
          >
            ...
            >
              ...
              <Box>
                <p className="text-[#404040] text-sm font-bold capitalize">
                  {userFullname}
                </p>
                <p className="text-[#565656] text-xs font-semibold capitalize">
                  {userRole === "admin"
                    ? "Admin"
                    : userRole === "owner"
                      ? "Pemilik"
